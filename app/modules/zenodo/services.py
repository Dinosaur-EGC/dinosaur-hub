...
class ZenodoService(BaseService):
    ...
    def create_new_deposition(self, dataset: DataSet) -> dict:
        ...
        metadata = {
            ...
            "keywords": (
                ["dinosaurhub"] if not dataset.ds_meta_data.tags else dataset.ds_meta_data.tags.split(", ") + ["dinosaurhub"]
            ),
            "access_right": "open",
            "license": "CC-BY-4.0",
        }
    ...
    def upload_file(self, dataset: DataSet, deposition_id: int, fossils_file: FossilsFile, user=None) -> dict:
        """
        ...
        """
        csv_filename = fossils_file.fossils_meta_data.csv_filename
