...
- **changelog**: 🎉 update version to 1.6.0 and add /version endpoint
- **tests**: enhance Fakenodo user simulation with dataset lifecycle tasks
- **tests**: enhance Hubfile user simulation with improved login and file discovery
- **tests**: enhance Flamapy user behavior simulation with improved login and dataset discovery
...
- **routes**: 🐛 remove trailing slash from DOI route
- **routes**: specify dataset_id type in route for dataset info retrieval
- **routes**: update endpoint and error messages for CSV validation
...
- **tests**: remove unused tasks for viewing other user profiles
